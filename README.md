...
<!--
  ...
  ║  Engine: Pure SVG + CSS Keyframes  ·  Theme: NEON MOTION         ║
  ╚══════════════════════════════════════════════════════════════════╝
-->

<div align="center">

<!-- ========== BOOT SEQUENCE (fades after 4s) ========== -->
<svg width="100%" height="300" viewBox="0 0 900 300" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <style>
      @keyframes fadeOutLoading { 0%,70%{opacity:1} 100%{opacity:0;visibility:hidden} }
      @keyframes loadingBar { 0%{width:0} 100%{width:260} }
...
<!-- ========== HOLOGRAPHIC CORE (3D Rotating Tesseract) ========== -->
<svg width="100%" height="320" viewBox="0 0 900 320" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <filter id="gi" x="-50%" y="-50%" width="200%" height="200%">
      <feGaussianBlur stdDeviation="6" result="blur"/><feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge>
    </filter>
    <style>
      @keyframes r3d{0%{transform:rotateX(0)rotateY(0)rotateZ(0)}100%{transform:rotateX(360deg)rotateY(360deg)rotateZ(360deg)}}
      @keyframes fp1{0%,100%{transform:translate(0,0)}50%{transform:translate(10px,-15px)}}
      @keyframes fp2{0%,100%{transform:translate(0,0)}50%{transform:translate(-12px,8px)}}
      @keyframes pg{0%,100%{opacity:0.4}50%{opacity:1}}
      .tesseract{animation:r3d 25s linear infinite;transform-origin:450px 160px}
      .p1{animation:fp1 4s ease-in-out infinite}.p2{animation:fp2 5s ease-in-out infinite}
      .pulse{animation:pg 2s ease-in-out infinite}
    </style>
  </defs>
  ...
  <g class="tesseract">
    <polygon points="400,60 480,100 450,160 370,120" fill="none" stroke="url(#hg)" stroke-width="1.5"/>
    <polygon points="480,100 580,70 550,130 450,160" fill="none" stroke="url(#hg)" stroke-width="1"/>
    <polygon points="450,160 550,130 500,220 400,250" fill="none" stroke="url(#hg)" stroke-width="1"/>
    <polygon points="370,120 450,160 400,250 320,200" fill="none" stroke="url(#hg)" stroke-width="1"/>
    <polygon points="400,60 370,120 320,70" fill="none" stroke="url(#hg)" stroke-width="0.8"/>
    <polygon points="580,70 550,130 620,100" fill="none" stroke="url(#hg)" stroke-width="0.8"/>
  ...
  <circle cx="250" cy="100" r="2" fill="#00ff9d" class="p1"/><circle cx="650" cy="200" r="2.5" fill="#00ff9d" class="p2"/>
  <circle cx="150" cy="220" r="1.8" fill="#00ff9d" class="p1"/><circle cx="750" cy="80" r="2" fill="#00ff9d" class="p2"/>
  <circle cx="500" cy="300" r="2" fill="#00ff9d" class="p1"/><circle cx="100" cy="160" r="1.5" fill="#00ff9d" class="p2"/>
  <circle cx="800" cy="260" r="2" fill="#00ff9d" class="p1"/>
  <circle cx="450" cy="160" r="8" fill="#00ff9d" filter="url(#gi)" class="pulse"/>
  <text x="450" y="300" font-family="'Fira Code',monospace" font-size="28" font-weight="bold" fill="url(#hg)" text-anchor="middle" filter="url(#gi)">KARTHIKEYAN S</text>
  <text x="450" y="318" font-family="'Fira Code',monospace" font-size="12" fill="#00ff9d" text-anchor="middle" opacity="0.8">AI ENGINEER · GENERATIVE AI · AGENTIC SYSTEMS</text>
</svg>
...
<svg width="720" height="400" viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <filter id="ng"><feGaussianBlur stdDeviation="3" result="blur"/><feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge></filter>
    <linearGradient id="lg" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#00ff9d" stop-opacity="0.8"/><stop offset="100%" stop-color="#1e1b4b" stop-opacity="0.4"/></linearGradient>
    <style>
      @keyframes nf{0%,100%{transform:translateY(0)}50%{transform:translateY(-8px)}}
      .fn{animation:nf 4s ease-in-out infinite}
    </style>
  </defs>
  ...
  <circle cx="400" cy="200" r="25" fill="#0f172a" stroke="#00ff9d" stroke-width="2.5" filter="url(#ng)" class="fn"/>
  ...
  <circle cx="180" cy="100" r="16" fill="#0f172a" stroke="#00ff9d" stroke-width="1.5" class="fn"/>
  <text x="180" y="105" font-family="'Fira Code'" font-size="7" fill="#00ff9d" text-anchor="middle">GenAI</text>
  <line x1="200" y1="105" x2="375" y2="190" stroke="url(#lg)" stroke-width="1.5"/>
  <circle cx="620" cy="100" r="16" fill="#0f172a" stroke="#00ff9d" stroke-width="1.5" class="fn"/>
  <text x="620" y="105" font-family="'Fira Code'" font-size="7" fill="#00ff9d" text-anchor="middle">CV</text>
  <line x1="600" y1="105" x2="425" y2="190" stroke="url(#lg)" stroke-width="1.5"/>
  <circle cx="180" cy="300" r="16" fill="#0f172a" stroke="#00ff9d" stroke-width="1.5" class="fn"/>
  <text x="180" y="305" font-family="'Fira Code'" font-size="7" fill="#00ff9d" text-anchor="middle">CySec</text>
  <line x1="200" y1="295" x2="375" y2="210" stroke="url(#lg)" stroke-width="1.5"/>
  <circle cx="620" cy="300" r="16" fill="#0f172a" stroke="#00ff9d" stroke-width="1.5" class="fn"/>
  <text x="620" y="305" font-family="'Fira Code'" font-size="7" fill="#00ff9d" text-anchor="middle">Agents</text>
  <line x1="600" y1="295" x2="425" y2="210" stroke="url(#lg)" stroke-width="1.5"/>
  <circle cx="120" cy="60" r="10" fill="#0f172a" stroke="#00ff9d" stroke-width="1"/><text x="120" y="63" font-family="'Fira Code'" font-size="6" fill="#00ff9d" text-anchor="middle">RAG</text><line x1="135" y1="65" x2="170" y2="95" stroke="#00ff9d" stroke-width="0.8" opacity="0.8"/>
  <circle cx="240" cy="60" r="10" fill="#0f172a" stroke="#00ff9d" stroke-width="1"/><text x="240" y="63" font-family="'Fira Code'" font-size="6" fill="#00ff9d" text-anchor="middle">LangG</text><line x1="225" y1="65" x2="190" y2="95" stroke="#00ff9d" stroke-width="0.8" opacity="0.8"/>
  <circle cx="560" cy="60" r="10" fill="#0f172a" stroke="#00ff9d" stroke-width="1"/><text x="560" y="63" font-family="'Fira Code'" font-size="6" fill="#00ff9d" text-anchor="middle">CNN</text><line x1="575" y1="65" x2="610" y2="95" stroke="#00ff9d" stroke-width="0.8" opacity="0.8"/>
  <circle cx="680" cy="60" r="10" fill="#0f172a" stroke="#00ff9d" stroke-width="1"/><text x="680" y="63" font-family="'Fira Code'" font-size="6" fill="#00ff9d" text-anchor="middle">OCV</text><line x1="665" y1="65" x2="630" y2="95" stroke="#00ff9d" stroke-width="0.8" opacity="0.8"/>
  <circle cx="120" cy="340" r="10" fill="#0f172a" stroke="#00ff9d" stroke-width="1"/><text x="120" y="343" font-family="'Fira Code'" font-size="6" fill="#00ff9d" text-anchor="middle">IDS</text><line x1="135" y1="335" x2="170" y2="305" stroke="#00ff9d" stroke-width="0.8" opacity="0.8"/>
  <circle cx="240" cy="340" r="10" fill="#0f172a" stroke="#00ff9d" stroke-width="1"/><text x="240" y="343" font-family="'Fira Code'" font-size="6" fill="#00ff9d" text-anchor="middle">Phish</text><line x1="225" y1="335" x2="190" y2="305" stroke="#00ff9d" stroke-width="0.8" opacity="0.8"/>
  <circle cx="560" cy="340" r="10" fill="#0f172a" stroke="#00ff9d" stroke-width="1"/><text x="560" y="343" font-family="'Fira Code'" font-size="6" fill="#00ff9d" text-anchor="middle">Orch</text><line x1="575" y1="335" x2="610" y2="305" stroke="#00ff9d" stroke-width="0.8" opacity="0.8"/>
  <circle cx="680" cy="340" r="10" fill="#0f172a" stroke="#00ff9d" stroke-width="1"/><text x="680" y="343" font-family="'Fira Code'" font-size="6" fill="#00ff9d" text-anchor="middle">Mem</text><line x1="665" y1="335" x2="630" y2="305" stroke="#00ff9d" stroke-width="0.8" opacity="0.8"/>
</svg>
...
<svg width="700" height="180" viewBox="0 0 700 180" xmlns="http://www.w3.org/2000/svg">
  <defs><linearGradient id="el" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stop-color="#00ff9d"/><stop offset="100%" stop-color="#1e1b4b"/></linearGradient></defs>
  <rect width="700" height="180" fill="#0a0a14" rx="8"/>
  <line x1="30" y1="90" x2="670" y2="90" stroke="url(#el)" stroke-width="3"/>
  <circle cx="120" cy="90" r="6" fill="#00ff9d"/><text x="120" y="75" font-family="'Fira Code'" font-size="8" fill="#00ff9d" text-anchor="middle">2024</text><text x="120" y="115" font-family="'Fira Code'" font-size="7" fill="#8892b0" text-anchor="middle">CED
